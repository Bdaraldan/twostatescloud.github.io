...
function catchSearch(opts, text) {
	lastSearchTerm = text;
	searchTable(opts, lastSearchTerm)
}
...
function searchTable(opts, searchTerm) {
  ...
  if (searchTerm.indexOf("::") > -1) {
	  ...
	  var stringObject = JSON.stringify(object.channelname + " " + object.category + " " + object.country + " " + object.language + " " + object.index + " " + object.team + " " + object.verifiedon + " " + object.added + " " + object.status);
		if (searchTerm[0].toLowerCase() == "category") {
			stringObject = JSON.stringify(object.category);
		} else if (searchTerm[0].toLowerCase() == "country") {
			stringObject = JSON.stringify(object.country);
		} else if (searchTerm[0].toLowerCase() == "language") {
			stringObject = JSON.stringify(object.language);
		} else if (searchTerm[0].toLowerCase() == "channelname") {
			stringObject = JSON.stringify(object.channelname);
		} else if (searchTerm[0].toLowerCase() == "index") {
			stringObject = JSON.stringify(object.index);
		} else if (searchTerm[0].toLowerCase() == "verifiedon") {
			stringObject = JSON.stringify(object.verifiedon);
		} else if (searchTerm[0].toLowerCase() == "added") {
	  ...
	  opts.data.forEach(function(object) {
		var stringObject = JSON.stringify(object.channelname + " " + object.category + " " + object.country + " " + object.language + " " + object.index + " " + object.team + " " + object.verifiedon + " " + object.added + " " + object.status);
		if (stringObject.match(searchTerm)) {
			filteredList.push(object);
		}
	  })
  } else {
	  opts.data.forEach(function(object) {
		var stringObject = JSON.stringify(object.channelname + " " + object.category + " " + object.country + " " + object.language + " " + object.index + " " + object.team + " " + object.verifiedon + " " + object.added + " " + object.status).toLowerCase();
